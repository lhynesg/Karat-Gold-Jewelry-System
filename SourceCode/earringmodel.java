PACKAGE: Model						CLASS: EaringModel
package model;
...
public class EarringModel extends connection{
	...
	{	
		try {
			...
			rs = st.executeQuery("select * from earrings");
			...
			while (rs.next())
			{
				...
				ImageIcon img = new ImageIcon("C:/Users/User/Desktop/icons/ear"+(x+1)+".JPG");
